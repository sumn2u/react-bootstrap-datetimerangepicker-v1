  ...
  render() {
    return (
      <Grid>
        <h2>Examples</h2>
        <Alert bsStyle="info">
          <Glyphicon glyph="bullhorn" />&nbsp;You can find <a href="https://github.com/sumn2u/react-bootstrap-datetimerangepicker-v1/tree/master/examples/src/js/components/examples">examples source code</a> here.
        </Alert>
        <hr/>
